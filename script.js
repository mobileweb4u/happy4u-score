...
const APP_VERSION = "2.4.2"; // UPDATED TO MASTER VERSION
...
document.getElementById('save-setup-btn').addEventListener('click', () => {
    ...
    // UPDATED CODE: Update the Header "Race To" number immediately
    document.getElementById('race-goal-display').innerText = gameState.raceTo;
